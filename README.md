...
# 📖 react-todo-app<a name="about-project"></a>
 ...
 React-todo-app is react tutorial where used the knowledge about React, components, props, state, and hooks.
...
```sh
git clone https://github.com/theresetuyi/react-todo-app.git
```
